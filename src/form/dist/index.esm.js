...
createContext(function () { return undefined; });
...
styled(C)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  position: absolute;\n  overflow: hidden;\n  border: none;\n  padding: 0;\n  height: 0;\n  width: 0;\n"], ["\n  position: absolute;\n  overflow: hidden;\n  border: none;\n  padding: 0;\n  height: 0;\n  width: 0;\n"])));
...
function Form(_a) {
    ...
    var _b = useReducer(reducer, __assign(__assign({}, initialState), { values: initialValues, disabledFields: disabledFields, initialValues: initialValues, disabled: disabled, schema: schema })), state = _b[0], dispatch = _b[1];
    useEffect(function () {
    ...
    var c = useMemo(function () { return children; }, [children]);
    return (
    // @ts-ignore
